...
public class _8_myAtoi {
    ...
    public static void main(String[] args) {
        ...
        String s = "";
        s = "42";
        System.out.println(42 == _8_myAtoi.myAtoi(s));
        s = "   -42";
        System.out.println(-42 == _8_myAtoi.myAtoi(s));
        s = "4193 with words";
        System.out.println(4193 == _8_myAtoi.myAtoi(s));
        s = "words and 987";
        System.out.println(4193 == _8_myAtoi.myAtoi(s));
        s = "-91283472332";
        System.out.println(Integer.MIN_VALUE == _8_myAtoi.myAtoi(s));
        s = "3.141592";
        System.out.println(3 == _8_myAtoi.myAtoi(s));
        s = " ";
        System.out.println(0 == _8_myAtoi.myAtoi(s));
        s = "2147483648";
        System.out.println(Integer.MAX_VALUE == _8_myAtoi.myAtoi(s));

        s = "-2147483647";
        System.out.println(-2147483647 == _8_myAtoi.myAtoi(s));
    }
}
